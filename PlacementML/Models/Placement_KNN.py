...
pipeline = Pipeline([('encoder',Preprocessor),('model',KNeighborsClassifier(n_neighbors=5))])
...
joblib.dump(pipeline,"Models/Placement_KNN.pkl")
loaded_pipeline = joblib.load("Models/Placement_KNN.pkl")
